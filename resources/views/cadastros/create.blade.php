      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <p class="lead">SSA – Serviço Social Autônomo</p>
            <hr class="my-4">
            <h4>Cadastro de Currículo</h4>
            <p>As vagas, quando existirem, serão preenchidas conforme disponibilidade e seguindo a ordem de inscrição, análise de currículos e entrevistas técnicas. <a href="www.google.com">Clique aqui para acessar o edital completo</a>.</p>
    ...
    <div class="container">
      ...
      <div class="form-group">
          <div class="alert alert-warning" role="alert">
            <h3>Anexos</h3>
            <p><strong  class="text-danger">(!)</strong> Só será aceitos os currículos no modelo disponiblizado. <a href="{{ asset('download/modelo-cv.docx') }}"> Clique aqui para baixar o modelo.</a></p>
      ...
      <div class="form-group">
        <ul class="list-group">
          <li class="list-group-item">
            <label for="arquivo1">Clique no botão a seguir para anexar seu currículo. O currículo deve seguir o modelo disponibilizado. <a href="{{ asset('download/modelo-cv.docx') }}"> Clique aqui para baixar o modelo.</a> Currículos fora do modelo indicado não serão avaliados. <strong  class="text-danger">(*)</strong></label>
